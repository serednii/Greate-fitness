...
/* harmony import */ var _functions_my_validate_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/my-validate-form */ "./src/js/functions/my-validate-form.js");
/* harmony import */ var _functions_my_validate_form__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_functions_my_validate_form__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _functions_setting__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/setting */ "./src/js/functions/setting.js");
/* harmony import */ var _functions_setting__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_functions_setting__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _popperjs_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @popperjs/core */ "./node_modules/@popperjs/core/lib/enums.js");
...
;
(() => {
  const button = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu-link.submenu-click');

  //when you click on outside the menu, close the menu
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', function (e) {
    const rez = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest('.menu-item.submenu-click-parent');
    rez.length === 0 && jquery__WEBPACK_IMPORTED_MODULE_0___default()('.submenu-click-list').removeClass('open-click');
  });

  //when you press esc close the menu
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('keydown', function (event) {
    if (event.keyCode === 27) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.submenu-click-list').removeClass('open-click');
    }
  });
  ...
  button.on('click', function (el) {
    ...
    button.each(function (_, e) {
      const list = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).closest('.submenu-click-parent').find('.submenu-click-list');
      if (clickedButton == e) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).toggleClass('open-click');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(list).toggleClass('open-click');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).removeClass('open-click');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(list).removeClass('open-click');
      }
    });
  });
})()
...
;
(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu-list .menu-item').each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).width(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).width() * 1.1);
  });
})();
